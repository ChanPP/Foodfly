...
```
docker build -t foodfly:local -f Dockerfile.local
...
```
docker build -t foodfly:dev -f Dockerfile.dev
...
```
docker build -t foodfly:production -f Dockerfile.production
...
```
docker build -t foodfly:base -f Dockerfile.base
